		...
		<div class="innerf-pages section">
			<div class="container">
				<div class="col-md-4 single-right-left ">
					<div class="grid images_3_of_2">
						<div class="flexslider1">
							<ul class="slides">
								<li data-thumb="<?php echo SITEPATH; ?>/web/images/csir_net.jpg">
									<div class="thumb-image">
										<img src="<?php echo SITEPATH; ?>/web/images/csir_net.jpg" data-imagezoom="true" alt=" " class="img-responsive"> </div>
								</li>
				...
				<div class="col-md-8 single-right-left simpleCart_shelfItem">
					<h3>CSIR-NET (Council of Scientific & Industrial Research)
					...
					<div class="desc_single">
						<h5>Description</h5>
						<p>CSIR stands for Council of Scientific & Industrial Research (CSIR). CSIR is a premier national R&D organisation and is among the world's largest publicly funded R&D organisation. CSIR (Council of Scientific & Industrial Research) conducts the Joint CSIR UGC NET, which is a national level entrance examination in the domain of Science including Life Sciences, Physical Sciences, Mathematical Sciences, Chemical Sciences and Earth Atmospheric Ocean and Planetary Sciences.</p>
					</div>
					...
					<div class="clearfix"></div>
					<a href="#" class="btn btn-info" role="button">Download SYLLABUS</a>
